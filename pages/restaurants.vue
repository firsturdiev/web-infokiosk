<template>
  <main class="site-content">
    <div class="site-content__start">
      <div class="dropdown">
        <button class="dropdown__btn">Kafe va restoranlar</button>
...
.item::before {
  ...
  width: 30px;
  height: 30px;
  background-image: url('~/assets/img/icon-restaurants.svg');
}
...
export default {
  ...
  async setup() {
    ...
    const hotels = await useFetch(config.public.strapiURL + '/api/restaurants?populate=*', {
      headers: {
